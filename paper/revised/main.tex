...
\section{Four Numbers a Red-Teaming Report Should Carry}
\label{sec:checklist}
...
severe the 0.75 threshold is. The task-specific prompt for SST-2 was
...
input's true label, which overstates attack success by $3.05\times$ pooled and
$19.5\times$ on topic classification. A probe can fail to be a well-formed input,
...
beside both, the generator's refusal rate per condition, and how many generations
the target model actually saw.
